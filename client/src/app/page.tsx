...
export default function Home() {
  ...
  const { writeAsync: registerUser, isPending: isRegisterLoading } = useContractWrite({
    address: CONTRACT_ADDRESS,
    abi: CONTRACT_ABI,
  ...
  const { writeAsync: withdraw, isPending: isWithdrawLoading } = useContractWrite({
    address: CONTRACT_ADDRESS,
    abi: CONTRACT_ABI,
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Pay-As-You-Go Electricity dApp</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="mb-4">
            <ConnectButton />
          ...
          {isConnected && !isRegistered && (
            <Alert>
              ...
              <AlertDescription>
                ...
                <Button onClick={handleRegister} disabled={isRegisterLoading} className="mt-2">
          ...
          {isConnected && isRegistered && (
            <Tabs defaultValue="dashboard">
              <TabsList className="grid w-full grid-cols-2">
                ...
                {isOwner === address && <TabsTrigger value="admin">Admin Panel</TabsTrigger>}
              </TabsList>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-2xl font-bold">{balance?.formatted} {balance?.symbol}</span>
                      </div>
                      <div>
                        <Input
                          type="number"
