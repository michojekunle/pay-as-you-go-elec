...
#### Extra notes
###### using rust
```Reference: https://docs.arbitrum.io/stylus/stylus-quickstart```
 - rustup target add wasm32-unknown-unknown
...
###### using solidity [hardhat]: 
 ```Reference: https://docs.arbitrum.io/build-decentralized-apps/quickstart-solidity-hardhat```
 - npm install --global yarn
 - yarn --version
 - yarn init -y
 - yarn add hardhat @nomicfoundation/hardhat-toolbox -D\yarn hardhat init
 - yarn hardhat init
